                    ...
                    <div className="space-y-8">
                        ...
                        <div className="space-y-6 justify-center">
                            <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="mailto:mhmdmahdi058@gmail.com" className="text-muted-foreground hover:text-primary transition-colors">
                             ...
                             <div className="flex items-start space-x-4">
                                ...
                                <div>
                                    ...
                                    <a href="tel:+96176931179" className="text-muted-foreground hover:text-primary transition-colors">
                                        +961 76 931 179
                                    </a>
                                </div>
                            </div>
                        ...
                        <div className="pt-8">
                            ...
                            <div className="flex space-x-4 justify-center">
                                <a href="https://linkedin.com/in/mhmdmahdi20" target="_blank">
                                    <Linkedin/>
                                </a>
                                ...
                                <a href="https://github.com/Mhmd769" target="_blank">
                                    <Github/>
                                </a>
                            </div>
                        </div>
