    ...
    <section id="contact" className="py-12 sm:py-16 lg:py-24 px-4 sm:px-6 lg:px-8 relative">
      <div className="w-full max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div>
                  ...
                  <span className="text-left text-foreground/70 text-sm sm:text-base">Beirut, Lebanon</span>
                </div>
              </div>
            </div>
            ...
            <div className="pt-6 sm:pt-8">
              ...
              <div className="flex justify-center gap-3 sm:gap-4">
                <a href="https://linkedin.com/in/mhmdmahdi20" target="_blank" className="p-2 sm:p-3 bg-primary/10 rounded-full hover:bg-primary/20">
                  <Linkedin className="h-5 w-5 sm:h-6 sm:w-6 text-primary" />
                </a>
                <a href="#" target="_blank" className="p-2 sm:p-3 bg-primary/10 rounded-full hover:bg-primary/20">
                  <Instagram className="h-5 w-5 sm:h-6 sm:w-6 text-primary" />
                </a>
                <a href="#" target="_blank" className="p-2 sm:p-3 bg-primary/10 rounded-full hover:bg-primary/20">
                  <Twitter className="h-5 w-5 sm:h-6 sm:w-6 text-primary" />
                </a>
                <a href="https://github.com/Mhmd769" target="_blank" className="p-2 sm:p-3 bg-primary/10 rounded-full hover:bg-primary/20">
          ...
          <form
            action="https://getform.io/f/akknorra"
            method="POST"
          ...
          >
            ...
            <div className="space-y-4 sm:space-y-6">
              <div>
                <label htmlFor="name" className="block text-xs sm:text-sm mb-2 font-medium">Your Name</label>
                <input type="text" id="name" name="name" required className="w-full px-3 sm:px-4 py-2 sm:py-3 rounded-md border border-border bg-background focus:outline-none focus:ring-2 focus:ring-primary text-sm sm:text-base" />
              </div>

              <div>
                <label htmlFor="email" className="block text-xs sm:text-sm mb-2 font-medium">Your Email</label>
                <input type="email" id="email" name="email" required className="w-full px-3 sm:px-4 py-2 sm:py-3 rounded-md border border-border bg-background focus:outline-none focus:ring-2 focus:ring-primary text-sm sm:text-base" />
              </div>

              <div>
                <label htmlFor="message" className="block text-xs sm:text-sm mb-2 font-medium">Your Message</label>
                <textarea id="message" name="message" rows={4} required className="w-full px-3 sm:px-4 py-2 sm:py-3 rounded-md border border-border bg-background focus:outline-none focus:ring-2 focus:ring-primary resize-none text-sm sm:text-base"></textarea>
              </div>
